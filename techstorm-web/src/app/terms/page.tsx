...
export const metadata: Metadata = {
  title: 'Terms of Service | TechStorm Global',
  description: 'Terms of Service for TechStorm Global platform.',
};

async function getTermsOfService() {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/legal/TERMS_OF_SERVICE`, { 
