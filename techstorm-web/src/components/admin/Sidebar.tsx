          ...
          <div className="flex-1 py-5 overflow-y-auto overflow-x-hidden">
            <nav className="flex flex-col gap-1">
                {[
                    ...
                    { path: "/admin/sponsors", icon: "fa-handshake", label: "Sponsors" },
                    { path: "/admin/testimonials", icon: "fa-comment-alt", label: "Testimonials" },
                    { path: "/admin/gallery", icon: "fa-images", label: "Our Impactors" },
                    { path: "/admin/team", icon: "fa-users-cog", label: "Leadership Team" },
